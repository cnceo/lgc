...
<div class="lot-wrap">
    ...
    <ul id="web_listOP_ul"><li class="hover"><a href="xjssc/">新疆时时彩</a></li><li><a href="xjssc/kaijiang.html">历史开奖号码</a></li><li><a href="xjssc/luzhunumber.html">号码路珠</a></li><li><a href="xjssc/luzhulonghu.html">龙虎路珠</a></li><li><a href="xjssc/luzhubigorsmall.html">单双大小路珠</a></li><li><a href="xjssc/luzhutotal.html">总和路珠</a></li><li><a href="xjssc/ballstat.html">单双大小历史</a></li><li><a href="xjssc/numberstat.html">历史号码统计</a></li><li><a href="xjssc/zoushitu.html">横版走势图</a></li><li><a href="jiqiao/xjssc/">新疆时时彩技巧</a></li><li><a href="xjssc/shipin" class="redColor">开奖视频</a></li><li><a href="xjssc/omitdata.html">遗漏大数据</a><span class="hoticon"></span> </li><li><a href="xjssc/twosidedstat.html">两面数据统计</a><span class="wen_newIcon"></span> </li></ul>
</div>
				<div class="clear"></div> 
				<!--  内容开始 -->
			        ...
			        <div class="index-history">
			            <div class="title mt10">
			                <h2>新疆时时彩开奖记录</h2>
			                <a href="xjssc/kaijiang.html" >查看全部>></a>
			            </div>       
				...
				<div class="l-title">
					<h2>新疆时时彩技巧</h2>
					<a href="jiqiao/xjssc/" >更多&gt;&gt;</a>
				</div>
				<div class="wrap">
    <ul>
	   <li><a target="_blank" href="jiqiao/xjssc/<?php echo ($artical_first['id']); ?>.html" >·<?php echo ($artical_first['title']); ?></a></li>
	   <?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><li><a target="_blank" href="jiqiao/xjssc/<?php echo ($data['id']); ?>.html">·<?php echo ($data["title"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
						</ul>
			...
			<div class="lot-about mt10">
                <div class="l-title">
					...
					<script type="text/javascript">
				        ...
				        function drawTrend() {
				            $.get("xjssc/numbertrendData.do", { ball: 1, count: 25, t: Math.random() }, function (data) {
				                showChartline("第一球走势图", data, function () { return this.x + '期:' + this.y }, 0, 10, true, 0, "sContainer");
				            }, "json");
				            
				        }
				        function getHistoryData(){
			        		$.post("xjssc/getHistoryData.do",
			       				{count:12}, 
			       				function(r) {
			        				if (r) {
