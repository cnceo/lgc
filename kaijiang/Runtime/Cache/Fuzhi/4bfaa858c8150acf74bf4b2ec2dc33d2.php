...
<div class="clear"></div> 
				<!--  内容开始 -->
					 <div id="lot-wrap"> 
					   <input type="hidden" id="callFun" value="twosidedstat" container="gdkl10twosidedstat" unload="0" time="10000" /> 
					   <a name="mark"></a> 
					   <ul class="lot-number-omit" style="margin-bottom: 20px;"> 
					    <li class="ball" id="choose_ball"> 
					     <ul> 
					      ...
					      <li><a href="javascript:void(0);" ball="6">第六球</a>| </li> 
					      <li><a href="javascript:void(0);" ball="7">第七球</a>| </li> 
					      <li><a href="javascript:void(0);" ball="8">第八球</a> </li> 
					     </ul> </li> 
					   </ul> 
					   <div class="twosidedtip">
					     *以每10期为一组，统计最近20组中单双大小的出现次数。 
					   </div> 
					   <div id="gdkl10twosidedstat">
					    ...
					    <script type="text/javascript">
					        ...
					        function changeBall(ball) {
					            ...
					            $.get("gdkl10/twoSidedStat.do", { t: Math.random(), id: ball }, function (r) {
