...
<div class="lot-wrap">
    ...
    <ul id="web_listOP_ul"><li><a href="xyft/">幸运飞艇</a></li><li><a href="xyft/kaijiang.html">历史开奖号码</a></li><li><a href="xyft/luzhulonghu.html">龙虎路珠</a></li><li><a href="xyft/luzhubigorsmall.html">单双大小路珠</a></li><li class="hover"><a href="xyft/luzhutotal.html">总和路珠</a></li><li><a href="xyft/ballstat.html">单双大小历史</a></li><li><a href="xyft/numberstat.html">历史号码统计</a></li><li><a href="xyft/zoushitu.html">横版走势图</a></li><li><a href="jiqiao/xyft/">幸运飞艇技巧</a></li><li><a href="xyft/shipin" class="redColor">开奖视频</a></li><li><a href="xyft/omitdata.html">遗漏大数据</a><span class="hoticon"></span> </li><li><a href="xyft/twosidedstat.html">两面数据统计</a><span class="wen_newIcon"></span> </li></ul>
</div>
				<div class="clear"></div> 
				<!--  内容开始 -->
				<input type="hidden" id="callFun" value="getLuzhuTotal"/>
    <script type="text/javascript" src="js/My97DatePicker/WdatePicker.js" ></script>
				...
				<div style="float: right; margin-bottom: 5px; margin-right: 68px;">
					<span class="InstructionsForUse"> <span
						class="InstructionsForUse_btn">使用说明 </span> <span class="position"
						style="left: -210px; top: 26px;"> <span class="content">1.表格需从左向右浏览，右侧一列为最新结果；<br />
								2.当长龙中断时，则另起一列显示结果；<br />
								3.20个号码加总的和值大于810，为和大；20个号码加总的和值小于810，则为和小，等于810则为和。
				...
				<table class="roadmap-table-caption">
					<tr>
						<td><span>今日累计：<span class="count"> 大（<span id="lzd"></span>） 小（<span id="lzx"></span>）
									和(<span id="lzh"></span>)</span>
						</span> 总和大小</td>
					</tr>
				</table>
				<div style="width: 980px; overflow-x: auto;" class="luzhu_scroll">
				  <div id="lzTotalDx_data-html"></div>
			      <script id="lzTotalDx_data-tmpl" type="text/template">
				...
				<table class="roadmap-table-caption">
					<tr>
						<td><span>今日累计：<span class="count"> 单（<span id="lzodd"></span>） 双（<span id="lzeven"></span>）
							</span>
						</span> 总和单双</td>
					</tr>
				</table>
						...
						<tr valign="top">
						  <td class="odd">
							{{
							  ...
							  <input type="hidden" id="lzoddval" value="{{=odd}}"/>
					          <input type="hidden" id="lzevenval" value="{{=even}}"/>
						</tr>
					</table>
				   </script>
				</div>
				<script type="text/javascript">
			      	function getLuzhuTotal(){
			      		var date=$("#dateData").val();
			      		$.post("xyft/getLuzhuTotal.do",
			   				{date:date,type:1}, 
			   				function(r) {
			    				if (r) {
			    					doTCompile("lzTotalDx_data", r);
		    						$("#lzd").html($("#lzdval").val());
		    						$("#lzx").html($("#lzxval").val());
		    						$("#lzh").html($("#lzhval").val());
			    				}
			      		...
			      		$.post("xyft/getLuzhuTotal.do",
				   				...
				   				function(r) {
				    				if (r) {
			    						...
			    						$("#lzodd").html($("#lzoddval").val());
			    						$("#lzeven").html($("#lzevenval").val());
				    				}
				   			}, "json");
			      	}
			      	getLuzhuTotal();
