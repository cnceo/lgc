...
<div class="lot-wrap">
    <div style="clear: left; width: 100%; float: left;">
        ...
        <div style="margin-right: 10px;" class="show-bjl">
            ...
            <span style="padding-left: 10px;"><a style="margin: 0px;" href="javascript:updatePickdate();">查询</a></span>
        </div>
        <script type="text/javascript">
            function updatePickdate() {
                var selDate = $("#dateData").val();
                $.get("/cqssc/getHaomaLuData.do", {
                    t : Math.random(),
                    date : selDate
                }, function(text) {
 ...
 //   console.log(webListOP);
    if (list.length > 0) {
        ...
        $('#web_listOP_ul').html(html);
				...
				<ul class="lot-number-omit clearleft mbottom10">
					<li id="ball-choose" class="ball">
						<ul style="width: 880px; float: left;">
							<li><span class="ckb"><b data-c="1"
									class="checkbox checked"></b></span><span class="ckb-txt"> <label>号码0</label></span></li>
							<li><span class="ckb"><b data-c="2"
									class="checkbox checked"></b></span><span class="ckb-txt"> <label>号码1</label></span></li>
							<li><span class="ckb"><b data-c="3"
									class="checkbox checked"></b></span><span class="ckb-txt"> <label>号码2</label></span></li>
							<li><span class="ckb"><b data-c="4"
									class="checkbox checked"></b></span><span class="ckb-txt"> <label>号码3</label></span></li>
							<li><span class="ckb"><b data-c="5"
									class="checkbox checked"></b></span><span class="ckb-txt"> <label>号码4</label></span></li>
							<li><span class="ckb"><b data-c="6"
									class="checkbox checked"></b></span><span class="ckb-txt"> <label>号码5</label></span></li>
							<li><span class="ckb"><b data-c="7"
									class="checkbox checked"></b></span><span class="ckb-txt"> <label>号码6</label></span></li>
							<li><span class="ckb"><b data-c="8"
									class="checkbox checked"></b></span><span class="ckb-txt"> <label>号码7</label></span></li>
							<li><span class="ckb"><b data-c="9"
									class="checkbox checked"></b></span><span class="ckb-txt"> <label>号码8</label></span></li>
							<li><span class="ckb"><b data-c="10"
									class="checkbox checked"></b></span><span class="ckb-txt"> <label>号码9</label></span></li>
							<li><span class="InstructionsForUse"> 
									<span class="InstructionsForUse_btn">使用说明 </span> 
									<span class="position"> 
										<span class="content">
												1.表格需从左向右浏览，右侧一列为最新结果；<br>
												2.当长龙中断时，则另起一列显示结果；<br>
												3.“X”表示历史对应的某一期未出现该号码，“√”表示历史对应的某一期未出现了该号码。
										</span>
									</span>
								</span>
							</li>
...
<!-- 								style="color: red;" class="all-ball" href="javascript:void(0);">全选</a></span> -->
<!-- 							<span -->
<!-- 								style="border-bottom: 1px solid black; padding-bottom: 2px;"><a -->
<!-- 								class="clear-ball" href="javascript:void(0);">清空</a></span> -->
<!-- 						</ul> -->
					</li>
				</ul>
				<div id="lot_content">
