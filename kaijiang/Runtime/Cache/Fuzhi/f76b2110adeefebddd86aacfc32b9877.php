...
<div class="lot-wrap">
    ...
    <ul id="web_listOP_ul"><li class="hover"><a href="pl3/">排列3</a></li><li><a href="pl3/kaijiang.html">历史开奖号码</a></li><li><a href="jiqiao/pl3/">排列3技巧</a></li><li><a href="pl3/shipin">开奖视频</a></li></ul>
				...
				<div class="wrap">
    <ul>
	   <li><a target="_blank" href="jiqiao/pl3/<?php echo ($artical_first['id']); ?>.html" >·<?php echo ($artical_first['title']); ?></a></li>
	   <?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><li><a target="_blank" href="jiqiao/pl3/<?php echo ($data['id']); ?>.html">·<?php echo ($data["title"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
						</ul>
