...
<script type="text/javascript">
    ...
    if (list.length > 0) {
        ...
        $('#web_listOP_ul').html(html);
				...
				<div class="clear"></div> 
				<!--  内容开始 -->
					<input type="hidden" id="callFun" value="getLuzhuNumber"/>
					<script type="text/javascript">   lotteryLuzhu = "xync_luzhunumber";</script>
				    ...
				    <div id="lot-wrap"> 
				     <ul class="lot-number-omit  mbottom10 clearleft"> 
				      <li class="ball" id="ball-choose" style="height: auto;"> 
				       <ul style="width: 880px; float: left;" class="ball-choose_ul"> 
				        <li><span class="ckb"><b class="checkbox checked" data-c="1"></b></span><span class="ckb-txt"> <label>号码1</label></span></li> 
				        <li><span class="ckb"><b class="checkbox checked" data-c="2"></b></span><span class="ckb-txt"> <label>号码2</label></span></li> 
				        <li><span class="ckb"><b class="checkbox checked" data-c="3"></b></span><span class="ckb-txt"> <label>号码3</label></span></li> 
				        <li><span class="ckb"><b class="checkbox checked" data-c="4"></b></span><span class="ckb-txt"> <label>号码4</label></span></li> 
				        <li><span class="ckb"><b class="checkbox checked" data-c="5"></b></span><span class="ckb-txt"> <label>号码5</label></span></li> 
				        <li><span class="ckb"><b class="checkbox checked" data-c="6"></b></span><span class="ckb-txt"> <label>号码6</label></span></li> 
				        <li><span class="ckb"><b class="checkbox checked" data-c="7"></b></span><span class="ckb-txt"> <label>号码7</label></span></li> 
				        <li><span class="ckb"><b class="checkbox checked" data-c="8"></b></span><span class="ckb-txt"> <label>号码8</label></span></li> 
				        <li><span class="ckb"><b class="checkbox checked" data-c="9"></b></span><span class="ckb-txt"> <label>号码9</label></span></li> 
				        <li><span class="ckb"><b class="checkbox checked" data-c="10"></b></span><span class="ckb-txt"> <label>号码10</label></span></li> 
				        <li><span class="ckb"><b class="checkbox checked" data-c="11"></b></span><span class="ckb-txt"> <label>号码11</label></span></li> 
				        <li><span class="ckb"><b class="checkbox checked" data-c="12"></b></span><span class="ckb-txt"> <label>号码12</label></span></li> 
				        <li><span class="ckb"><b class="checkbox checked" data-c="13"></b></span><span class="ckb-txt"> <label>号码13</label></span></li> 
				        <li><span class="ckb"><b class="checkbox checked" data-c="14"></b></span><span class="ckb-txt"> <label>号码14</label></span></li> 
				        <li><span class="ckb"><b class="checkbox checked" data-c="15"></b></span><span class="ckb-txt"> <label>号码15</label></span></li> 
				        <li><span class="ckb"><b class="checkbox checked" data-c="16"></b></span><span class="ckb-txt"> <label>号码16</label></span></li> 
				        <li><span class="ckb"><b class="checkbox checked" data-c="17"></b></span><span class="ckb-txt"> <label>号码17</label></span></li> 
				        <li><span class="ckb"><b class="checkbox checked" data-c="18"></b></span><span class="ckb-txt"> <label>号码18</label></span></li> 
				        <li><span class="ckb"><b class="checkbox checked" data-c="19"></b></span><span class="ckb-txt"> <label>号码19</label></span></li> 
				        <li><span class="ckb"><b class="checkbox checked" data-c="20"></b></span><span class="ckb-txt"> <label>号码20</label></span></li> 
				       </ul> 
				       <ul style="float: right; width: 100px; text-align: right;"> 
				        ...
				        <span class="InstructionsForUse" style="margin-left:20px;"> <span class="InstructionsForUse_btn">使用说明 </span> <span class="position" style="left:-200px;top:26px;"> <span class="content">1.表格需从左向右浏览，右侧一列为最新结果；<br /> 2.当长龙中断时，则另起一列显示结果；<br /> 3.“X”表示历史对应的某一期未出现该号码，“√”表示历史对应的某一期未出现了该号码。 </span> </span> </span> 
				       </ul> </li> 
				     </ul> 
				     <div id="lot_content"> 
				      <div id="lzNumber_data-html"></div>
				      <script id="lzNumber_data-tmpl" type="text/template">
				      	  {{
				      	  for(var i=1;i<=20;i++){
				      		  var row=it[i+""];
				      	  }}  
					      	<div class="luzhu t_{{=i}}" style="clear:both;"> 
						       <table class="roadmap-table-caption"> 
						        <tbody>
						         <tr> 
						          <td> <span>今日累计：<span class="count"> 总来（<span id="zl{{=i}}"></span>） 没来（<span id="ml{{=i}}"></span>） </span> </span> 号码{{=i}} </td> 
						         </tr> 
						        </tbody>
						       </table> 
						       <div style="width: 980px; overflow-x: auto;" class="luzhu_scroll"> 
						        <table class="roadmap-table mb-15" style="font-family:微软雅黑;"> 
						         <tbody>
						          ...
						          <input type="hidden" id="zlval{{=i}}" value="{{=zl}}"/>
						          <input type="hidden" id="mlval{{=i}}" value="{{=ml}}"/>
						          </tr> 
						         </tbody>
						        </table> 
						       </div> 
				      ...
				      <script type="text/javascript">
				      	function getLuzhuNumber(){
				      		...
				      		$.post("xync/getLuzhuNumber.do",
				   				{date:date}, 
				   				function(r) {
				    				if (r) {
				    					doTCompile("lzNumber_data", r);
				    					for(var i=1;i<=20;i++){/*替换总来与没来数据*/
				    						$("#zl"+i).html($("#zlval"+i).val());
				    						$("#ml"+i).html($("#mlval"+i).val());
				    					}
				    				}
				   			}, "json");
				      	}
