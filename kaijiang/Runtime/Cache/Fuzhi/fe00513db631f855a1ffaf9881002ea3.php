                    ...
                    <div id="lot-wrap" style="margin-bottom: 20px;">
                        ...
                        <ul class="lot-number-omit" style="margin-bottom: 20px;">
                                ...
                                <ul id="rankUl">
                                    ...
                                    <li>
                                        <span class="InstructionsForUse">
                                            <span class="InstructionsForUse_btn ">
                                                	使用说明
                                            </span>
                                            <span class="position">
                                                <span class="content">
                                                    1.表格统计了不同条件下号码的出现次数及遗漏（未出现）次数；
                                                    <br />
                                                    2.输代表截止当前未出现的总次数，赢代表截止当前连续出现的总次数；
                                                    <br />
                                                    3.点击向上或向下的三角标识，可按对应标签的出现次数排序。
                                                </span>
                                            </span>
                                        </span>
                                    </li>
                            ...
                            <li class="type">
                                <ul id="dataTypeUl">
                                    <li>
                                        <a href="javascript:gotoPage(2)" id="dataTypeLi2">
                                            	龙虎
                                        </a>
                                    </li>
                                    <li>
                                        <a href="javascript:gotoPage(3)" id="dataTypeLi3">
                                            	冠亚和单双
                                        </a>
                                    </li>
                                    <li>
                                        <a href="javascript:gotoPage(4)" id="dataTypeLi4">
                                          	  冠亚和大小
                                        </a>
                                    </li>
                                    <li>
                                        <a href="javascript:gotoPage(5)" id="dataTypeLi5">
                                       	     单双
                                        </a>
                                    </li>
                                    <li>
                                        <a href="javascript:gotoPage(6)" id="dataTypeLi6">
                                            	大小
                                        </a>
                                    </li>
                                    <li>
                                        <a href="javascript:gotoPage(1)" class='cur' id="dataTypeLi1">
                                            	单号
                                        </a>
                                    </li>
                                </ul>
                        ...
                        <div id='lot_content'>
<!--                             <input type="hidden" id="pageName" value="yilou/1-1-1" controller="/missing/"/> -->
                            	<input type="hidden" id="callFun" value="getMissingList"/>
                        ...
                        <script type="text/javascript">
                        	...
                        	function gotoPage(dataTypeNum,rankNum){
                        		...
                        		if(rankNum)
                        			rank=rankNum;
                           	 	window.location.href="pk10/yilou.html#dataType="+dataType+"&gameId="+gameId+"&rank="+rank+"&orderCloumn="+orderCloumn+"&orderType="+orderType;
                           		getMissingList();
                           	}
