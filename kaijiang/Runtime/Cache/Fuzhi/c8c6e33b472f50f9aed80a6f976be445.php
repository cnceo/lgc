    ...
    <input type="hidden" value="getHistoryData|drawTrend" id="callFun" time="1000" />
		...
		<div class="index-history">
            <div class="title mt10">
                <h2>
                    重庆时时彩开奖记录</h2>
                <a href="cqssc/kaijiang.html" >查看全部&gt;&gt;</a>
            </div>
			...
			<div class="lot-article mt10">
				<div class="l-title">
					<h2>重庆时时彩技巧</h2>
					<a href="jiqiao/cqssc/" >更多&gt;&gt;</a>
				</div>
				<div class="wrap">
				
    <ul>
	   <li><a target="_blank" href="jiqiao/cqssc/<?php echo ($artical_first['id']); ?>.html" >·<?php echo ($artical_first['title']); ?></a></li>
	   <?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><li><a target="_blank" href="jiqiao/cqssc/<?php echo ($data['id']); ?>.html">·<?php echo ($data["title"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
						</ul>
